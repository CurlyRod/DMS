	...
	<div class="wrapper">
			...
			?>
				...
				<?php  
					 ...
					 include 'db_connection.php'; 
					 $query =("SELECT role,count(role)as roletype from tbl_users group by role");
				...
				?> 
				 ...
				 <?php 
				 		include 'db_connection.php'; 
						$query = "SELECT MONTHNAME(date_upload) as dateuploads,COUNT(date_upload) as uploads from tbl_files GROUP by STR_TO_DATE(CONCAT('0001 ', dateuploads, ' 01'), '%Y %M %d')";
