        ...
        <div class="col-9"  >
             ...
             <?php 
				...
				while($id > 0){
					...
					echo '<script>
						$("#paths").prepend("<a href=\"admindashboard.php?page=adminfiles&fid='.$path['id'].'\">'.$path['foldername'].'</a>/")
					</script>';
					$id = $path['parent_id'];

				}
				echo '<script>
						$("#paths").prepend("Directory: <a href=\"admindashboard.php?page=adminfiles\">Home</a>/")
					</script>';
				?>
					</div>
...
location.href = 'admindashboard.php?page=adminfiles&fid='+$(this).attr('data-id')
})      
...
// alert(flder_id); 
// var fileId = $(this).val();
location.href=('admindashboard.php?page=adminsharefolder&folderid='+flder_id);
	...
	$(document).on('click','.shareFile',function(){ 
		...
		var fileId = $(this).val();
		location.href=('admindashboard.php?page=adminshare&fileid='+fileId);
