<div class="row">
                    ...
                    <script src="./src/js/adminfilesave.js" type="text/javascript"></script>
                                            <script> 
                                       const fileInput = document.querySelector("#files");

                            fileInput.addEventListener("ondragover", function(event) {
                            event.preventDefault();
                            });

                            fileInput.addEventListener("ondrop", function(event) {
                            event.preventDefault();
                            });
