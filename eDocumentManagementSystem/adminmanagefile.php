        ...
        <div class="col-8"  >
             ...
             <?php 
				...
				while($id > 0){
					...
					echo '<script>
						$("#paths").prepend("<a href=\"admindashboard.php?page=adminmanagefile&fid='.$path['id'].'\">'.$path['foldername'].'</a>/")
					</script>';
					$id = $path['parent_id'];

				}
				echo '<script>
						$("#paths").prepend("Directory: <a href=\"admindashboard.php?page=adminmanagefile\">Home</a>/")
					</script>';
				?>
					</div>
...
location.href = 'admindashboard.php?page=adminmanagefile&fid='+$(this).attr('data-id')
})     
...
$(document).on('click','#unlinkFolder',function(){ 
		 ...
		 location.href=('admindashboard.php?page=adminunsharefolder&uqfolderid='+flderid );
