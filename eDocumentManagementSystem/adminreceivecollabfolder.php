        ...
        <div class="col-9"  >
             ...
             <?php 
				...
				while($id > 0){
					...
					echo '<script>
						$("#paths").prepend("<a href=\"admindashboard.php?page=adminreceivecollabfolder&fid='.$path['id'].'\">'.$path['foldername'].'</a>/")
					</script>';
					$id = $path['parent_colab_id'];

				}
				echo '<script>
						$("#paths").prepend("Directory: <a href=\"admindashboard.php?page=adminreceivecollabfolder\">Home</a>/")
					</script>';
				?>
					</div>
...
location.href = 'admindashboard.php?page=adminreceivecollabfolder&fid='+$(this).attr('data-id')
})     
...
console.log(value);
location.href = 'admindashboard.php?page=fileupload&fid='+ value;
}) 
//FILE
