<?php  
    ...
    { 
      ...
      $check  = "SELECT * FROM tbl_folders where user_id ='".$_SESSION['id']."' and foldername  ='".$foldername."' and parent_id ='".$parent_id."' ";
      ...
      if(mysqli_num_rows($execute)>0){
            ...
            $save = "INSERT INTO tbl_folders (user_id,foldername,parent_id)  VALUES ('$user_id','$foldername','$parent_id')" ;
...
{ 
    ...
    $selectIDs = "SELECT * FROM tbl_folders WHERE id=".$flderid; 
