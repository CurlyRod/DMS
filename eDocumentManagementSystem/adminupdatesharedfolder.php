                ...
                <div class="col-12 " > 
                    ...
                    <select  id="userlist" class="form-control mt-2  userlist-for-share   mb-3 border-0" name="userlist[]" multiple="multiple"style="width: 100%"> 
                       ...
                       $id_list = implode(',', $id_array);
                        $query = "SELECT * FROM tbl_users where id IN($id_list)and id <> ".$_SESSION['id'] ; 
...
$(document).on('submit','#sharefolder',function(e){
        ...
        formData.append("updatefoldershare",true);
        ...
        $.ajax({
            ...
            contentType:false,
             ...
             var res = jQuery.parseJSON(response);
                ...
                setTimeout(()=> {
                window.location.href="admindashboard.php?page=adminlinkfolder";
