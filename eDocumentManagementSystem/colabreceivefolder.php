        ...
        <div class="col-9"  >
             ...
             <?php 
				...
				while($id > 0){
					...
					echo '<script>
						$("#paths").prepend("<a href=\"userdashboard.php?page=colabreceivefolder&fid='.$path['id'].'\">'.$path['foldername'].'</a>/")
					</script>';
					$id = $path['parent_colab_id'];

				}
				echo '<script>
						$("#paths").prepend("Directory: <a href=\"userdashboard.php?page=colabreceivefolder\">Home</a>/")
					</script>';
				?>
					</div>
...
location.href = 'userdashboard.php?page=colabreceivefolder&fid='+$(this).attr('data-id')
})     
...
console.log(value);
location.href = 'userdashboard.php?page=fileupload&fid='+ value;
}) 
//FILE
