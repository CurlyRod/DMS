        ...
        <div class="col-9"  >
             ...
             <?php 
				...
				while($id > 0){
					...
					echo '<script>
						$("#paths").prepend("<a href=\"userdashboard.php?page=collab&fid='.$path['id'].'\">'.$path['foldername'].'</a>/")
					</script>';
					$id = $path['parent_colab_id'];

				}
				echo '<script>
						$("#paths").prepend("Directory: <a href=\"userdashboard.php?page=collab\">Home</a>/")
					</script>';
				?>
					</div>
...
$(document).on('click','#unlinkFolder',function(){ 
     ...
     var flderid = $(this).attr("data-id");
          location.href=('userdashboard.php?page=colabupdatefolder&uqfolderid='+flderid );
...
location.href = 'userdashboard.php?page=collab&fid='+$(this).attr('data-id')
})      
...
// alert(flder_id); 
// var fileId = $(this).val();
location.href=('userdashboard.php?page=colabuserfolder&folderid='+flder_id);
