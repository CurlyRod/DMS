	...
	<nav id="sidebar" class="sidebar js-sidebar" >
				<div class="sidebar-content js-simplebar ">
					<a class="sidebar-brand" href="admindashboard.php?page=adminhome" >
			<span class="align-middle"><img src="./dashboard/images/sampless.png" class="logo" > </span>
					...
					<ul class="sidebar-nav">
						...
						<li class="sidebar-item  ">
							<a class="sidebar-link" href="admindashboard.php?page=adminhome"> 
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=adminfiles">
							<span class="align-middle"><img src="./dashboard/images/documents.png" class="img-size"alt="" >
						Files</span>
						</a>
						</li>
						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=recent">
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=adminlinkfolder">
							<span class="align-middle"><img src="./dashboard/images/Linkfolder.png" class="img-size"alt="" >
						Link Folder</span> </a>
						</li> 
						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=adminsharefile">
							<span class="align-middle"><img src="./dashboard/images/links.png"  class="img-size"alt="" >
						Link Files</span> </a>
						</li> 
						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=adminreceivefile">
							<span class="align-middle"><img src="./dashboard/images/review.png"  class="img-size"alt="" >
						Received Files</span> </a>
						</li> 
						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=adminmanagefile">
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=totaluser">
							<span class="align-middle"><img src="./dashboard/images/group (1).png" class="img-size"alt="" >
					Total Account</span> </a>
							</li>

						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=totalfiles">
							<span class="align-middle"><img src="./dashboard/images/file.png" class="img-size"alt="" >
					Total Files</span> </a>
						</li> 
						
						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=totalshared">
							<span class="align-middle"><img src="./dashboard/images/shared.png" class="img-size"alt="" >
					Total Shared</span> </a>
						</li>  
						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=totalfolders">
							<span class="align-middle"><img src="./dashboard/images/backupfolder.png" class="img-size"alt="" >
					Total Folders</span> </a>
						</li> 
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=admincollab">
							<span class="align-middle"><img src="./dashboard/images/team-work.png"  class="img-size"alt="" >
						Workstation</span> </a>
						</li> 
						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=adminreceivecollabfolder">
				...
				<i class="align-middle" data-feather="bar-chart-2"></i> <span class="align-middle">Account</span>
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=archivemodule/archiveuser">
							<span class="align-middle"><img src="./dashboard/images/team.png" class="img-size"alt="" >
						Account</span> </a>
						</li>

						<li class="sidebar-item">
							<a class="sidebar-link" href="admindashboard.php?page=archivemodule/archivefiles">
							<span class="align-middle"><img src="./dashboard/images/files.png" class="img-size"alt="" >
						File</span> </a> 

						<a class="sidebar-link" href="admindashboard.php?page=userarchivefolder">
							<span class="align-middle"><img src="./dashboard/images/backupfolder.png" class="img-size"alt="" >
					Folder</span> </a>
						</li>  
						<li class="sidebar-item  ">
  ...
  xhr.onreadystatechange = function() {
		...
		var maxStorage =  formatBytes(16106127360) ; 
		var totalUserStorage = formatBytes(0+response.data); 
		
		var defaultStorage = formatBytes(0);
		
	  document.getElementById("allotedSize").innerHTML = totalUserStorage +" TOTAL";
