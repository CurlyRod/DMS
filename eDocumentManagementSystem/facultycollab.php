        ...
        <div class="col-9"  >
             ...
             <?php 
				...
				while($id > 0){
					...
					echo '<script>
						$("#paths").prepend("<a href=\"facultydashboard.php?page=facultycollab&fid='.$path['id'].'\">'.$path['foldername'].'</a>/")
					</script>';
					$id = $path['parent_colab_id'];

				}
				echo '<script>
						$("#paths").prepend("Directory: <a href=\"facultydashboard.php?page=facultycollab\">Home</a>/")
					</script>';
				?>
					</div>
...
$(document).on('click','#unlinkFolder',function(){ 
     ...
     var flderid = $(this).attr("data-id");
          location.href=('facultydashboard.php?page=facultycollabupdate&uqfolderid='+flderid );
...
location.href = 'facultydashboard.php?page=facultycollab&fid='+$(this).attr('data-id')
})      
...
// alert(flder_id); 
// var fileId = $(this).val();
location.href=('facultydashboard.php?page=facultycollabfolder&folderid='+flder_id);
	...
	$(document).on('click','.shareFile',function(){ 
		...
		var fileId = $(this).val();
		location.href=('facultydashboard.php?page=fileshare&fileid='+fileId);
