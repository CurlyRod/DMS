...
<div class="col-3"> 
        ...
        <div class="col-12">
            ...
            <?php
                  ...
                  $qry = $conn->query("SELECT * FROM tbl_colab_folder where id=".$_GET['uqfolderid'])->fetch_array();
                  extract($_POST);
            ...
            <input type="hidden" id="folderid" name="folderid" value="<?php echo isset($_GET['uqfolderid']) ? $_GET['uqfolderid'] :'' ?>">
                ...
                <span><button type="submit"class=" btn btn-success" id="sharefolder"><i class="fa-solid fa-share mr-1"></i>Update Share</button></span>
...
$(document).on('submit','#sharefolder',function(e){
        ...
        formData.append("update_collab_foldershare",true);
        ...
        $.ajax({
            ...
            contentType:false,
             ...
             var res = jQuery.parseJSON(response);
                ...
                setTimeout(()=> {
                window.location.href="facultydashboard.php?page=facultycollab";
