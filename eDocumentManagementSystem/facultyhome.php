									...
									<div class="col-sm-6">
										<div class="card border  ">
											<div class="card-body">
												<div class="row">
											 	...
											 	<div class="row">
													<div class="col">  
													<h1 class="mt-1 mb-2"><?php echo $conn->query('SELECT * FROM  tbl_folders WHERE user_id = '.$_SESSION['id'])->num_rows ?></h1>
											
                                                    <a href="facultydashboard.php?page=facultyfiles" class=""> 
                                                    ...
                                                    <a href="facultydashboard.php?page=userarchivefolder" class="">  
													<h1 class="mt-1 mb-2"><?php echo $conn->query('SELECT * FROM  tbl_folders  WHERE archive = 1 and user_id='.$_SESSION['id'])->num_rows ?></h1>
											
                                                    <button class="btn btn-primary btn-sm" style="width:76px;">  ARCHIVE </button>
                                                    </a>
                                                    </div>
										...
										<div class="card border">
											<div class="card-body">
												<div class="row">
													<div class="col mt-0">
														<h5 class="card-title">TOTAL ARCHIVE</h5>
													</div>
												...
												<div class="row"> 
													  <div class="col "> 
                                                <h1 class="mt-1 mb-2"><?php echo $conn->query("SELECT * FROM tbl_files WHERE archive = 3 and user_id=".$_SESSION['id'] )->num_rows ?></h1>												
												<a href="facultydashboard.php?page=archivemodule/userarchivefile" class=""> 
                                                    <button class="btn btn-primary btn-sm" style="width:76px;">FILE </button>
                                                    </a>	
													...
													<div class="col">  
														...
														<button class="btn btn-primary btn-sm" style="width:76px;"> FOLDER </button>
														</a>
														</div>
									...
									<div class="col-sm-6">
										<div class="card border">
											<div class="card-body">
                                                ...
                                                <div class="row"> 
                                                <div class="col">
                                                <h1 class="mt-1 mb-2"><?php echo $conn->query('SELECT * FROM  tbl_files WHERE archive = 0 and user_id='.$_SESSION['id'])->num_rows ?></h1>												
                                                <a href="userdashboard.php?page=files" class=""> 
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="row"> 
													<div class="col "> 
													<h1 class="" ><?php echo $conn->query("SELECT a.username as uname,a.lastname as lname,u.user_id,u.date_upload as dateshare ,f.*FROM tbl_files f inner join tbl_share u on u.user_id = f.user_id INNER join tbl_users as a ON a.id = u.public_to  and f.id = u.file_id WHERE u.user_id=".$_SESSION['id'])->num_rows?>
											
													</h1> 
                                                    <a href="facultydashboard.php?page=facultysharefiles" class=""> 
                                                    <button class="btn btn-primary btn-sm" style="width:75px;">  FILE  </button>
                                                    </a>
													
													</div> 
													<div class="col "> 
													<h1 class=""><?php echo $conn->query("SELECT u.public_to,a.username as uname,a.lastname as lname,u.user_id,u.date_shared as dateshare ,f.*FROM tbl_folders f inner join tbl_share_folder u on u.user_id = f.user_id INNER join tbl_users as a ON a.id = u.public_to  and f.id = u.folder_id WHERE u.user_id=".$_SESSION['id'])->num_rows;?>
													</h1>  
                                                    <a href="facultydashboard.php?page=facultylinkfolder"> 
                                                        <button class="btn btn-primary btn-sm" style="width:75px;">FOLDER</button>
                                                    </a>
