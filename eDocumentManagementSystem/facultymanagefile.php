        ...
        <div class="col-8"  >
             ...
             <?php 
				...
				while($id > 0){
					...
					echo '<script>
						$("#paths").prepend("<a href=\"facultydashboard.php?page=facultymanagefile&fid='.$path['id'].'\">'.$path['foldername'].'</a>/")
					</script>';
					$id = $path['parent_id'];

				}
				echo '<script>
						$("#paths").prepend("Directory: <a href=\"facultydashboard.php?page=facultymanagefile\">Home</a>/")
					</script>';
				?>
					</div>
...
location.href = 'facultydashboard.php?page=facultymanagefile&fid='+$(this).attr('data-id')
})     
...
$(document).on('click','#unlinkFolder',function(){ 
		 ...
		 location.href=('facultydashboard.php?page=userunsharefolder&uqfolderid='+flderid );
