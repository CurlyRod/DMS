...
<h1 class="h3  "><span><img src="./dashboard/images/links.png"" alt="" style="height:40px;width:40px;"> </span>SHARED FILES</h1>
     
     <?php include('db_connection.php') ;
        $files = $conn->query("SELECT a.firstname as uname,a.lastname as lname,u.user_id,u.date_upload as dateshare ,f.*FROM tbl_files f inner join tbl_share u on u.user_id = f.user_id INNER join tbl_users as a ON a.id = u.public_to WHERE f.archive = 0  and u.user_id = '".$_SESSION['id']."' and f.id = u.file_id  order by date(u.date_upload) desc");
          ...
          ?> 
                      ...
                      >
                        <thead >
                          ...
                          <th class="text-center fw-normal " >Receiver</th>
                                ...
                                <th  class="text-center fw-normal ">Date Share</th>
                        ...
                        ?>
                            <tr class='file-item' data-id="<?php echo $row['id'] ?>" data-name="<?php echo $name ?>">
                                ...
                                <td  class="text-center"><i class="to_file"><?php echo $row['file_type'] ?></i></td>
                                 ...
                                 <td   class="text-center" ><i><?php echo date('Y/m/d h:i A',strtotime($row['dateshare'])) ?></i></td>
    ...
    $(document).on('click','.deleteFile',function(e){   
         ...
         var fileId = $(this).val();
         location.href=('facultydashboard.php?page=updateshare&uqfileid='+fileId);
