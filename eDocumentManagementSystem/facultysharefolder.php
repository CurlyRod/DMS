...
<div class="col-3"> 
        ...
        <div class="col-12">
            ...
            <?php
                  ...
                  $qry = $conn->query("SELECT * FROM tbl_folders where id=".$_GET['folderid'])->fetch_array();
                  extract($_POST);
...
$(document).on('submit','#sharefolder',function(e){
        ...
        formData.append("sendfolder",true);
        ...
        $.ajax({
            ...
            contentType:false,
             ...
             var res = jQuery.parseJSON(response);
                ...
                setTimeout(()=> {
                window.location.href="facultydashboard.php?page=facultyfiles";
