        ...
        <div class="col-9"  >
             ...
             <?php 
				...
				while($id > 0){
					...
					echo '<script>
						$("#paths").prepend("<a href=\"userdashboard.php?page=files&fid='.$path['id'].'\">'.$path['foldername'].'</a>/")
					</script>';
					$id = $path['parent_id'];

				}
				echo '<script>
						$("#paths").prepend("Directory: <a href=\"userdashboard.php?page=files\">Home</a>/")
					</script>';
				?>
					</div>
...
location.href = 'userdashboard.php?page=files&fid='+$(this).attr('data-id')
})      
...
// alert(flder_id); 
// var fileId = $(this).val();
location.href=('userdashboard.php?page=usersharefolder&folderid='+flder_id);
