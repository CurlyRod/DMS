...
<div class="row">  
                  ...
                  <option value="User" <?php echo isset($meta['type']) && $meta['type'] == 'User' ? 'selected': '' ?>>User</option>
                        ...
                        <thead style="background:#83C9FF;" >
                          <tr class="  fw-bold text-dark" > 
                                ...
                                <th  class="text-center fw-normal">Date Created</th>  
    ...
    <?php
                         ...
                         $users = $conn->query("SELECT u.role as role ,u.firstname as firstname,u.lastname as lastname,f.foldername as foldername,f.date_created as date_created from tbl_users as u INNER join tbl_folders as f on u.id = f.user_id ");
