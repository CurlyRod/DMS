...
<h1 class="h3  "><span><img src="./dashboard/images/shared.png" alt="" style="height:40px;width:40px;"> </span>SHARED FILES</h1>
     
     <?php include('db_connection.php') ;
        $files = $conn->query("SELECT a.username as uname,a.lastname as lname,u.user_id,u.date_upload as dateshare,f.*FROM tbl_files f inner join tbl_share u on u.user_id = f.user_id INNER join tbl_users as a ON a.id = u.public_to WHERE f.archive = 0  and f.id = u.file_id  order by date(u.date_upload) desc");
