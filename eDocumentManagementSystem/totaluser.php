...
<h1 class="h3  "><span><img src="./img/sidebar/paper.png" alt="" style="height:40px;width:40px;"> </span> TOTAL USER</h1>
<style>  
    #adduser:hover{ 
    cursor: pointer;  
	border:0;
              ...
              <option value="User" <?php echo isset($meta['type']) && $meta['type'] == 'User' ? 'selected': '' ?>>User</option>
                    ...
                    <thead style="background:#83C9FF;" >
                      <tr class="  fw-bold text-dark" > 
                            ...
                            <th  class="text-center fw-normal">Password</th>  
                            <th  class="text-center fw-normal">Type</th>   
...
<?php
 					...
 					$users = $conn->query("SELECT * FROM tbl_users WHERE archive = 'Active'  order by firstname   asc");
             ...
             <td class="text-center" >
               ...
               <td class="text-center text-success">		<?php echo $row['status'] ?>  </td>
                ...
                <div class="dropdown">
                  ...
                  <li><a class="dropdown-item "><button class="viewUser btn" value='<?php echo $row['id']?>'><img src="./dashboard/images/eye.png"" style="width:20px;heigth:20px;"> 
                    View</button></a></li>
