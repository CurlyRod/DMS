									...
									<div class="col-sm-6">
											...
											<div class="card-body">
												<div class="row">
											 	...
											 	<div class="row">
                                                    ...
                                                    <a href="userdashboard.php?page=userarchivefolder" class="">  
										...
										<div class="card border">
											<div class="card-body">
												...
												<a href="userdashboard.php?page=archivemodule/archivefiles" class=""> 
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="row"> 
                                                    ...
                                                    <a href="userdashboard.php?page=usersharefile" class=""> 
                                                    <button class="btn btn-primary btn-sm" style="width:75px;">  FILE  </button>
                                                    </a>
                                                    ...
                                                    <a href="userdashboard.php?page=userslinkfolder"> 
                                                        <button class="btn btn-primary btn-sm" style="width:75px;">FOLDER</button>
                                                    </a>
