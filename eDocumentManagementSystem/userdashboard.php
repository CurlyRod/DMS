  ...
  background: #555; 
	...
	<div class="wrapper">
			...
			<?php 
				...
				include('./userdashboard/sidebar.php');
			?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Understood</button>-->
				...
				<div class="success-danger " style=" padding: 10px 20px;"> 


				<span class="img"><img src="./attention.png" alt="" style="height:35px; width:35px;"></span>
				<span class="msg"></span>
				<div class="close-btn">
				<span class="fas fa-times fa-2x"></span>
				</div>
...
function alertCustomize() 
 ...
 function dangeralertCustomize() 
 { 
    $('.success-danger').addClass("show");
          $('.success-danger').removeClass("hide");
          $('.success-danger').addClass("showAlert");  
           
           setTimeout(function(){
             $('.success-danger').removeClass("show");
             $('.success-danger').addClass("hide");
           },1000);
