	...
	<nav id="sidebar" class=" sidebar js-sidebar " >
				<div class="sidebar-content js-simplebar ">
					<a class="sidebar-brand" href="userdashboard.php?page=userdash" >
			<span class="align-middle"><img src="./dashboard/images/sampless.png" class="logo" > </span>
					...
					<ul class="sidebar-nav"> 
						...
						<li class="sidebar-item  ">
							<a class="sidebar-link" href="userdashboard.php?page=userdash"> 
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="userdashboard.php?page=files">
							<span class="align-middle"><img src="./dashboard/images/copy.png" class="img-size"alt="" >
						Files</span>
						</a>
						</li>
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="userdashboard.php?page=userrecent">
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="userdashboard.php?page=collab">
							<span class="align-middle"><img src="./dashboard/images/team-work.png"  class="img-size"alt="" >
						Workstation</span> </a>
						</li> 
						<li class="sidebar-item">
							<a class="sidebar-link" href="userdashboard.php?page=colabreceivefolder">
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="userdashboard.php?page=archivemodule/userarchivefile">
							<span class="align-middle"><img src="./dashboard/images/redo.png" class="img-size"alt="" >
					File</span> </a> 

					<a class="sidebar-link" href="userdashboard.php?page=userarchivefolder">
					...
					<div class="navbar-collapse collapse">
						<ul class="navbar-nav navbar-align">
							<li class="nav-item dropdown">
								<a class="nav-icon dropdown-toggle d-none" href="#" id="alertsDropdown" data-bs-toggle="dropdown">
							...
							<li class="nav-item dropdown">
								<a class="nav-icon dropdown-toggle d-none" href="#" id="messagesDropdown" data-bs-toggle="dropdown">
									<div class="position-relative">
										<i class="align-middle" data-feather="message-square"></i>
									</div>
								</a>
								<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0 d-none" aria-labelledby="messagesDropdown">
									<div class="dropdown-menu-header">
										<div class="position-relative">
											4 New Messages
										</div>
