        ...
        <div class="col-9"  >
             ...
             <?php 
				...
				while($id > 0){
					...
					echo '<script>
						$("#paths").prepend("<a href=\"userdashboard.php?page=userslinkfolder&fid='.$path['id'].'\">'.$path['foldername'].'</a>/")
					</script>';
					$id = $path['parent_id'];

				}
				echo '<script>
						$("#paths").prepend("Directory: <a href=\"userdashboard.php?page=userslinkfolder\">Home</a>/")
					</script>';
				?>
					</div>
...
location.href = 'userdashboard.php?page=userslinkfolder&fid='+$(this).attr('data-id')
})     
...
$(document).on('click','#unlinkFolder',function(){ 
    ...
    var flderid = $(this).attr("data-id");
         location.href=('userdashboard.php?page=updatesharedfolder&uqfolderid='+flderid );
